	...
	public void createPage(){
		...
		try{
			...
			if(result == 4){
				...
				sendChunkLine("<style>body{font-family: \"Times New Roman\", Arial, serif;font-weight: normal; background-image: radial-gradient(circle at center, rgb(180,255,160), rgb(10,50,0));}.message{height:100%; font-size: 5em; text-align: center; color: rgb(10,50,0);}</style>");
				sendChunkLine("</head>");
				sendChunkLine("<body><div class=\"message\"><p> CONGRATULATIONS, YOU WON ! </p></div></body>");
				sendChunkLine("</html>");
			}
			...
			//User lost
				...
				sendChunkLine("<style>body{font-family: \"Times New Roman\", Arial, serif;font-weight: normal; background-image: radial-gradient(circle at center, rgb(180,255,160), rgb(10,50,0));}.message{height:100%; font-size: 5em; text-align: center; color: rgb(10,50,0);}</style>");
				sendChunkLine("</head>");
				sendChunkLine("<body><div class=\"message\"><p> GAME OVER ! </p></div></body>");
				sendChunkLine("</html>");
			}
