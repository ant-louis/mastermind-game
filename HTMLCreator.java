...
public class HTMLCreator {
	...
	private String createSelectionBoard(){
		...
		//Submit button
		selectionBoard.append("<div class=\"button\"><button id=\"submit-button\" id=\"submit-js\"> Submit </button></div>");
